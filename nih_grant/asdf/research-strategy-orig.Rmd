...
output: 
   pdf_document: 
      ...
      # template: pandoc-wrapfig-template.tex
      keep_tex: true
...
```{r echo=F, fig.height = 6, out.width = ".3\\textwidth", fig.cap = "Important scatterplot", fig.align="center"}
ggplot(mtcars,aes(x=mpg,y=hp)) + geom_point()
```

asdfasdfa 

```{r echo=F, fig.height = 6, out.width = ".3\\textwidth", fig.cap = "Important scatterplot", fig.align="center", wrapfigure = list("R", .3)}
ggplot(mtcars,aes(x=mpg,y=hp)) + geom_point()
```
